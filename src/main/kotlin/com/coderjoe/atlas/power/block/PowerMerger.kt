            ...
            if (source.hasPower()) {
                ...
                if (pulled > 0) {
                    ...
                    plugin.logger.atlasInfo(
                        """
                        PowerMerger at ${'$'}{location.blockX},${'$'}{location.blockY},${'$'}{location.blockZ} pulled ${'$'}pulled power from ${'$'}{source::class.simpleName} at ${'$'}{face.name} (now ${'$'}currentPower/${'$'}maxStorage)
                        """.trimIndent(),
                    )
                }
            }
