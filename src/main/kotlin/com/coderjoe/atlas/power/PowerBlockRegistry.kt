...
class PowerBlockRegistry(plugin: JavaPlugin) : BlockRegistry<PowerBlock>(plugin) {
    ...
    fun registerPowerBlock(powerBlock: PowerBlock, blockId: String) = register(powerBlock, blockId)
    ...
    fun getAdjacentPowerBlock(location: Location, face: BlockFace): PowerBlock? = getAdjacentBlock(location, face)
