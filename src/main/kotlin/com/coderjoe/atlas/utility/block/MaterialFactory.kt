 ...
 * live here and the two subclasses supply nothing but numbers, the same split [Mine] uses for the
 * seven ore rigs.
 */
abstract class MaterialFactory(
     ...
     * siphon [Mine.canOutputToward] guards against.
     */
     ...
     * way [com.coderjoe.atlas.power.block.LavaGenerator] answers this for power.
     */
     ...
     * loose drop above the factory when nothing is attached. Mirrors [Mine.haulDestination].
     */
